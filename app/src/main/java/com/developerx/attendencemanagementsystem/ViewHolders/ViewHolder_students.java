package com.developerx.attendencemanagementsystem.ViewHolders;
...
import com.developerx.attendencemanagementsystem.RealmDatabase.Attendance_Reports;
import com.developerx.attendencemanagementsystem.RealmDatabase.Attendance_Students_List;
    ...
    public ViewHolder_students(@NonNull final View itemView, Activity MainActivity, RealmResults<Students_List> list, final String roomID) {
        ...
        layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StudentBottomEditSheet student_edit_sheet = new StudentBottomEditSheet(stuName, regNo, mobileNo);
                student_edit_sheet.setStyle(DialogFragment.STYLE_NORMAL, R.style.AppTheme_AppBarOverlay);
